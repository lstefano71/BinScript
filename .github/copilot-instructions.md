...
- when the C-ABI surface changes (new/modified exports), update **all** consumers listed in the maintenance checklist at the bottom of `docs/C_ABI.md`: the canonical header (`src/BinScript.Interop/binscript.h`), the integration examples (`tools/examples/`), the tutorial chapters 15–17, and the Python CLI tool (`tools/bsxtool/`).
